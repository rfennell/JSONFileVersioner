...
var endOfLine = (__nccwpck_require__(37).EOL);
...
function findFiles(dir, filename, filelist, enableRecursion) {
    var path = path || __nccwpck_require__(17);
    var fs = fs || __nccwpck_require__(147), files = fs.readdirSync(dir);
    filelist = filelist || [];
...
const core = __importStar(__nccwpck_require__(186));
const fs = __nccwpck_require__(147);
const AppyVersionToJSONFileFunctions_1 = __nccwpck_require__(715);
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
